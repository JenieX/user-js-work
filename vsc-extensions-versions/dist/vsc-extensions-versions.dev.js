// ==UserScript==
// @name           jx-vsc-extensions-versions-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/vsc-extensions-versions';

if (isExposed) {
  bundleURL = `${exposerUUID}/vsc-extensions-versions/dist/vsc-extensions-versions.bundle.js`;
}
