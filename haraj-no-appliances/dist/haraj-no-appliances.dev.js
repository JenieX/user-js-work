// ==UserScript==
// @name           jx-haraj-no-appliances-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/haraj-no-appliances';

if (isExposed) {
  bundleURL = `${exposerUUID}/haraj-no-appliances/dist/haraj-no-appliances.bundle.js`;
}
