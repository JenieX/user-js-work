// ==UserScript==
// @name           jx-haraj-no-playstation-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/haraj-no-playstation';

if (isExposed) {
  bundleURL = `${exposerUUID}/haraj-no-playstation/dist/haraj-no-playstation.bundle.js`;
}
