// ==UserScript==
// @name           jx-haraj-sticky-header-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/haraj-sticky-header';

if (isExposed) {
  bundleURL = `${exposerUUID}/haraj-sticky-header/dist/haraj-sticky-header.bundle.js`;
}
