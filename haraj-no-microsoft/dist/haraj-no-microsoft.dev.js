// ==UserScript==
// @name           jx-haraj-no-microsoft-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/haraj-no-microsoft';

if (isExposed) {
  bundleURL = `${exposerUUID}/haraj-no-microsoft/dist/haraj-no-microsoft.bundle.js`;
}
