// ==UserScript==
// @name           jx-haraj-search-history-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/haraj-search-history';

if (isExposed) {
  bundleURL = `${exposerUUID}/haraj-search-history/dist/haraj-search-history.bundle.js`;
}
