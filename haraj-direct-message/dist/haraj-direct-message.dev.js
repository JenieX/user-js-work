// ==UserScript==
// @name           jx-haraj-direct-message-dev
// @version        0.0.0
...
let bundleURL = 'http://localhost:1013/haraj-direct-message';

if (isExposed) {
  bundleURL = `${exposerUUID}/haraj-direct-message/dist/haraj-direct-message.bundle.js`;
}
